...
begin
  ...
  insert into public.flag_library (user_id, category, service_name, flag_hours, is_default) values
    ...
    (new.id, 'Alignment', 'Alignment Check', 0.6, true),
    (new.id, 'Alignment', 'Standard Alignment', 1.2, true),
    (new.id, 'Alignment', 'Steering Angle Sensor Recalibration', 0.2, true),
    (new.id, 'Alignment', 'Alignment Recheck (Warranty)', 0.8, true),
    ...
    (new.id, 'Diagnostic', 'Courtesy Check', 0.1, true),
